...
<script type="text/javascript">
    createCarousel("{{ page.image-assets-dir | escape }}/day-one-exports/", {{ site.data.year-in-review.year-2020.Books-processed.entries | jsonify }}, "carousel-books");
</script>

# Movies Watched
<div id="image-cloud-movies">
    <script type="text/javascript">
        createImageCloud("{{ page.image-assets-dir | escape }}/day-one-exports/", {{ site.data.year-in-review.year-2020.Movies-processed.entries | jsonify }}, "image-cloud-movies")
    </script>
</div>

<div id="carousel-movies"></div>
<script type="text/javascript">
    createCarousel("{{ page.image-assets-dir | escape }}/day-one-exports/", {{ site.data.year-in-review.year-2020.Movies-processed.entries | jsonify }}, "carousel-movies");
</script>

# TV Shows Watched
<div id="image-cloud-tv">
    <script type="text/javascript">
        createImageCloud("{{ page.image-assets-dir | escape }}/day-one-exports/", {{ site.data.year-in-review.year-2020.TV-shows-processed.entries | jsonify }}, "image-cloud-tv")
    </script>
</div>
<div id="carousel-tv"></div>
<script type="text/javascript">
    createCarousel("{{ page.image-assets-dir | escape }}/day-one-exports/", {{ site.data.year-in-review.year-2020.TV-shows-processed.entries | jsonify }}, "carousel-tv");
</script>
...
<div id="image-cloud-games">
    <script type="text/javascript">
        createImageCloud("{{ page.image-assets-dir | escape }}/day-one-exports/", {{ site.data.year-in-review.year-2020.Games-processed.entries | jsonify }}, "image-cloud-games")
    </script>
</div>
<div id="carousel-games"></div>
<script type="text/javascript">
    createCarousel("{{ page.image-assets-dir | escape }}/day-one-exports/", {{ site.data.year-in-review.year-2020.Games-processed.entries | jsonify }}, "carousel-games");
</script>

# Memorable Beverages

<div id="image-cloud-beverages">
    <script type="text/javascript">
        createImageCloud("{{ page.image-assets-dir | escape }}/day-one-exports/", {{ site.data.year-in-review.year-2020.Beverages-processed.entries | jsonify }}, "image-cloud-beverages")
    </script>
</div>
<div id="carousel-beverages"></div>
<script type="text/javascript">
    createCarousel("{{ page.image-assets-dir | escape }}/day-one-exports/", {{ site.data.year-in-review.year-2020.Beverages-processed.entries | jsonify }}, "carousel-beverages");
</script>
